...
public class AccelerometreCommande extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_accelerometre_commande);
		...
		accelerationLayout.addView(accelerometreMoniteur, layoutParam);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.accelerometre_commande, menu);
		return true;
	}
